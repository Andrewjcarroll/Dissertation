...
We compare evolutions using compact and explicit finite difference operators
against a more highly resolved sixth order explicit finite difference
evolution. {\bf EWH:  Can you provide the actual resolution, i.e. finest spacing, h, for these runs?  Also, what is the order of accuracy of the CFD used here?}  
