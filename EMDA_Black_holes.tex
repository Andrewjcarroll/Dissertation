...
\mu &= 0 .
\end{align}
In the context of EMDA, the absence of additional matter fields is trivially expressed as the the vanishing of the associated gauge, dilaton, and axion fields: 
\begin{align}
A_a dx^a &= 0, \\
\phi &= 0, \\
\kappa &= 0 .
...
\mu &= 0 .
\end{align}
In the context of EMDA, the absence of additional scalar fields is trivially expressed as the the vanishing of the associated dilaton and axion fields: 
\begin{align}
\phi &= 0, \\
\kappa &= 0 .
\end{align}
...
% {\bf EWH:  Just a thought, you have the electrically charged Kerr--Newman metric.  Ought you to include the dyonic Kerr--Newman metric as well?  It is not a limit of Kerr--Sen, so probably not, but I thought I would ask.} 
...
d\Omega^2 = d\theta^2+\sin^2\theta\,d\varphi^2 .
\end{equation}
The coupling dependent parameter (in this appendix only) \(\alpha_1\) is 
defined by
\begin{equation}
