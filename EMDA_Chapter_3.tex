...
\end{equation}
where $R$ is the Ricci scalar, $F_{ab}$ is the $U(1)$ field strength, and $(*F)_{ab}$ is its dual. The constants $\alpha_0$ and $\alpha_1$ determine the coupling strengths between the dilaton, axion, and electromagnetic field. 
...
\caption[Einstein--Maxwell and strong-coupling EMDA waveform comparison]{Peak-aligned comparison of the dominant gravitational-wave strain between the Einstein--Maxwell reference waveform, $(\alpha_0,\alpha_1)=(0,0)$, and the strongest-coupling EMDA case, $(\alpha_0,\alpha_1)=(100,100)$. The waveforms agree extremely well, with a mismatch on the order of $10^{-5}$.}
...
\caption[Dilaton $(2,2)$ radiation across coupling strengths]{
...
{\bf EWH:  Perhaps you intended this with the FloatBarrier below, but on my pdf, the section heading is in the top 20\% of the page and the actual table is on the next page.  If you wanted that, I guess it's fine, but it does seem like an awful lot of white space for a table I would think should fit on a single page.} 
