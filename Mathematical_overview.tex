...
We will now build up the mathematical foundation needed to construct the so-called ADM decomposition and the resulting ADM equations.\footnote{ADM stands for Arnowitt--Deser--Misner; after Richard Arnowitt, Stanley Deser, and Charles Misner. The ADM equations arise from a $(3+1)$ decomposition of the Einstein equations.} The freedom to choose a foliation of spacetime is needed to formulate the Cauchy problem in general relativity and in alternative theories of gravity. We foliate the spacetime into a family of spacelike hypersurfaces $(\Sigma_t)$, which may be interpreted as slices of constant coordinate time $(t)$.
...
The Ricci tensor can be written in several equivalent forms. In terms of the spatial metric $\gamma_{ij}$, it contains second derivatives of the metric:   {\bf EWH:  Can you put the next equation on a single line?}  
\begin{equation}
\begin{aligned}
R_{ij}
&=
