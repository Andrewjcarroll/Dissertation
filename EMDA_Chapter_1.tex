...
\end{align}
where {\bf EWH:  Check this equation reference.  For me it was broken.}  Eqs.~\eqref{Kerr-Sen_dilaton} and~\eqref{Kerr-Sen_axion}
...
{\bf EWH:  The next two tables appear across a page break.  It would be well to have them on a single page.  Also, it appears to be too wide in my pdf version.  Will that be a problem for the department or graduate studies?} 
