...
For completeness, we present the full equations of motion and their $3+1$ decomposition.

\subsection{EMDA equations of motion}
\label{sec:eom}
...
constraint violations for the full simulation are shown in Figs.~\ref{fig:constraint_ham_mom} and \ref{fig:constraint_divb}.
