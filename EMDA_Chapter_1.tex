...
\end{align}
where Eq.~\ref{Kerr-Sen_dilaton} gives the form for an axion and dilaton field for a single Kerr--Sen black hole (albeit in Boyer--Lindquist type coordinates) for our current theory parameters of $(\alpha_0,\alpha_1) = (1,1)$. 
