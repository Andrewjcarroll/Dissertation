\chapter{Running the EMDA Code on MaryLou}
...
computational domain. Function~6, developed by William Black, has worked well in
...
These parameters define the extent of the computational domain. The
...
are reasonable defaults for a q=1 black hole, but higher values may be needed for
more accurate initial data and higher mass ratios.
