...
% \end{table}
% \begin{figure}\centering
%   \includegraphics[width=\linewidth]{figures/U_E0_DIFF__ALL_FAMILIES.png}  \includegraphics[width=\linewidth]{figures/U_B1_DIFF__ALL_FAMILIES.png}
...
\begin{figure}[t]
    ...
    resolution. The CFD operators remain stable in the nonlinear system. Notice that again in this nonlinear system the 4th order A4 and C4 operators perform the same as the Explicit 4th order at half of the resolution. 
    }
...
\begin{figure}[t]
    ...
    nonlinear sigma model, the sixth order CFD operators do not achieve
