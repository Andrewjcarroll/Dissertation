...
To study the strong-field dynamics and gravitational radiation from inspiraling charged black hole binaries in Einstein--Maxwell--dilaton--axion (EMDA) theory, we evolve the full EMDA system as a Cauchy initial-value problem. The EMDA field equations and their $3+1$ decomposition are given in Eqs.~\ref{eq:YOUR_FIRST_EQ}--\ref{eq:YOUR_LAST_EQ} of the previous chapter. {\bf EWH:  This last equation reference don't show for me.  You may want to check these again.}  The spacetime metric is evolved using the BSSN formulation \cite{Shibata1995_BSSN,Baumgarte1999_BSSN,Baumgarte2010}, together with puncture gauge conditions \cite{Campanelli2006,Baker2006}. The electromagnetic, dilaton, and axion fields are evolved using the corresponding matter evolution equations obtained from this $3+1$ decomposition.
