...
representative constraint histories for the $q=1$ and $q=8$
...
The unequal-mass $q=8$ simulation provides a more demanding numerical
test than the equal-mass case because the smaller black hole introduces
a shorter physical length scale. Nevertheless, the constraints remain
